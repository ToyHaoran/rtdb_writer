...
./verify_and_run static_write \
  ...
  --static_analog=../CSV20240614/1718350759143_REALTIME_FAST_STATIC_ANALOG.csv \
  --static_digital=../CSV20240614/1718350759143_REALTIME_FAST_STATIC_DIGITAL.csv \
  --unit_number=2 \
  --type=0 \
...
./verify_and_run his_fast_write \
    ...
    --random_av=false \
    --magic=10 \
    --param=his_fast_write,xty111:6667,root,root,1000,4000,root.sg
```
